...
def load_and_clean_csv(filepath):
    ...
    # Rename unnamed first column if present
    df.columns = [
        'Sno' if 'Unnamed' in col else col
...
if __name__ == "__main__":
    ...
    if not tables:
        ...
        # ── Chart 1: Count of Use Cases by Client (Horizontal Bar) ───────────────────
        ...
        # ── Chart 6: Top 15 Industry / Business Domains (Bar) ────────────────────────
        ...
        if algo_col:
            ...
            df_split = df[algo_col].str.split(",", expand=True)
        ...
        # ── Prepare table data for the interactive data table ────────────────────────
        ...
        <div class="table-section">
            <div class="table-wrapper">
                <table id="project-table">
                    ...
                    <tbody id="table-body">
                        {"".join(
                            "<tr>" + "".join(f"<td title='{str(cell)}'>{str(cell)}</td>" for cell in row) + "</tr>"
        ...
        <footer>
            Auto-generated Dashboard | Data Science Projects Tracker
        </footer>
        ...
        <script>
            ...
            // Get column indices for filters
            ...
            function applyFilters() {{
                ...
                const filtered = allData.filter(row => {{
                    ...
                    return matchStatus && matchClient && matchDomain;
                }});
